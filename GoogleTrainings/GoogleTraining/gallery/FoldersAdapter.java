...
import devrari.sandeep.googletraining.FragmentFolderAllImages;
...
public class FoldersAdapter extends RecyclerView.Adapter<FoldersAdapter.FolderHolder> {
    ...
    public FoldersAdapter(Context context, List<CustomGalleryGETSET> list, FragmentManager fragmentManager) {
    ...
    public void onBindViewHolder(FolderHolder holder, int position) {
        ...
        Glide.with(context).load("file://"+treeSet.first())
